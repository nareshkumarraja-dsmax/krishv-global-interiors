        ...
        <div class="gallery-banner-overlay">
            <div class="gallery-banner-content">
                <div class="breadcrumb-nav">
                    ...
                    <span class="current-page">Home Automation</span>
                </div>
                <h2 class="banner-text animate-fade">
                    "Automated Living <span>Experience</span>".
                </h2>
            </div>
        </div>
    </section>
        ...
        <div class="rooms container">
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 about-sec align-self-center wow fadeInRight"  data-wow-delay="0.2s">
                    <p class="room sub-title">Seamless Automation : <span class="text-transparent">The Smart Home Experience</span> </p>
                        <p class="mb-10 para" >
                            Krish-V Global Interiors integrates smart home automation with your interior design, giving you effortless control over lighting, climate, entertainment, and security. We create intuitive and discreet solutions that enhance your home's functionality and luxury.
                        </p>
                        <p class="para">
                            Experience a smarter, more convenient lifestyle with a home that seamlessly responds to your needs.
                        </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="krish-v-cta-content">
                <div class="krish-v-cta-image">
                    <img src="@assetPath('assets/img/team/graphical-image/Home-automation.png')" alt="Transform" />
                </div>
